...
public class DialogManifestationTable extends ManifestationTable {
	private final TextArea dialogText;
	private final TextField originText, typeText;
	...
	public DialogManifestationTable(Skin skin, DialogManifestation manifestation) {
		...
		dialogText = new TextArea(manifestation.getDialog(), skin);
		...
		add(dialogText).colspan(3).minSize(350f, 100f);
		row();
