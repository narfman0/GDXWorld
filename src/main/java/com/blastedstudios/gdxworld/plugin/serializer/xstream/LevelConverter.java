...
/**
 * Does not work yet, needs plenty tweaks. First it will work here as the old
 * version does, then I will push it to the respective plugins, then I will
 * make custom handlers and effectively remove the code from this location and
 * make each plugin completely self sustained. Long process, however, this is
 * the first stage.
 */
